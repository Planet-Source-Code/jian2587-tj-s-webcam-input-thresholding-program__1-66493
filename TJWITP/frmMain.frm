...
Dim s As String
s = "- Click a point in the picture to select the threshold color. " & vbCrLf & _
"- There're several different thresholding functions in this program. Change them in the Timer1 sub. " & vbCrLf & _
"- Use IsAboveRBelowGB function to supress green and blue components. Useful for detecting authentic red pixels. " & vbCrLf & _
"- Why do we supress green and blue? Because white pixels have high red values, too, and it's not red. " & vbCrLf & _
"- Authentic red pixels usually have low green and blue components. " & vbCrLf & _
"- All the same, you can change the procedure so that it supresses either red, green or/and blue components. " & vbCrLf & _
"- Recommended under uniform lighting conditions. Best at tracking distinct grouped pixels, like a bright red light stick. " & vbCrLf & _
"- Please do give me credits if you use/port any codes or features from this program. Million Thanks!"
MsgBox s, vbInformation Or vbSystemModal
End Sub
